      ...
      <div className="about-us-container">
        ...
        <div className="container md:flex-col items-center mx-auto  mb-28">
          <p className='text-lg px-10'>
            Cyber Eyes Networks, a dynamic tech hub founded in 2023 by Brian Karanja and Brian Ndegwa, is passionate about empowering the Mount Kenya region. 
            <br />
            <br />
        ...
        <div className="flex flex-col container mx-auto md:flex-row-reverse items-center my-12">
          ...
          <div className="md:w-1/2 p-8">
            ...
            <div>
              <p className='text-lg mb-2'>We offer:</p>
              <ul className='list-none list-inside'>
                <li>★ Hackathons and bootcamps to spark creativity and collaboration</li>
                <li>★ Comprehensive training programs to equip individuals with the skills they need to thrive.</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="my-20 container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-8">Why Cyber Eyes Networks?</h2>
